...
const LoginPage=({loading,error,...props})=>{
    ...
    return (
        <div className="login-page mx-5 my-0 py-5">
                    ...
                    <div className="card fat">
                        <div className="card-body">
                            ...
                            <form className="my-login-validation" onSubmit={handleSubmit} noValidate={false}>
                                <div className="form-group" style={{'font':'icon'}}>
                                ...
                                <div className="form-group my-2" style={{'font':'icon'}}>
                                    <label>Password
                                        <a href="forgot.html" className="float-right mx-5" style={{'font':'icon'}}>
                                            Forgot Password?
                                        </a>
                                    </label>
